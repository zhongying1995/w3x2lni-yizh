...
local template = ui.container {
    ...
    ui.container {
        ...
        ui.button {
            ...
            color = '#00ADD9',
            style = { MarginTop = 1, MarginBottom = 1, Height = height },
            on = {
                click = function()
                    window._mode = 'lni'
        ...
        ui.button {
            title = lang.ui.CONVERT_TO..'ModelMap',
            color = '#D9903C',
            style = { MarginTop = 1, MarginBottom = 1, Height = height },
            on = {
                click = function()
                    window._mode = 'ModelMap'
                    window:set_theme('W3x2ModelMap', '#D9903C')
                    window:show_page 'convert'
                    window:set_theme('W3x2ModelMap', '#D9903C')
                end
            }
